...
assert.equal(packageJson.build.executableName, "FamilyTreeCircle");
...
assert.match(mainProcess, /void downloadUpdateInBackground\(\)/);
assert.match(mainProcess, /if \(!downloadedUpdateVersion\)/);
assert.match(mainProcess, /getAppIconPath\(\)/);
assert.match(mainProcess, /icon: appIconPath/);
assert.match(mainProcess, /mainWindow\.setIcon\(appIconPath\)/);
...
assert.match(mainProcess, /fullscreen: true/);
assert.match(mainProcess, /fullscreenable: true/);
assert.doesNotMatch(mainProcess, /mainWindow\.maximize\(\)/);
